    ...
    tasks.forEach(task => {
        task.addEventListener('click', function(e) {
            ...
            if (text.contentEditable === 'false' || text.contentEditable === 'inherit') {
                ...
                const check = [task.querySelector('.check-case svg'), task.querySelector('.check-case'), text];

                if (check.some(el => el === e.target)) {
    ...
    edits.forEach(edit => {
        edit.addEventListener('click', function (e) {
            ...
            if (edit.classList.contains('editing')) {
                ...
                edit.setAttribute('viewBox', '0 0 21 15');
            } else {
                ...
                edit.setAttribute('viewBox', '0 -0.5 21 21');
                storeData();
            }
